...
namespace game
{
	...
	{
	public:
		HandleUIComponent(RamCoreEngine::GameObject* gameObject, uint8_t smallFontSize, uint8_t bigFontSize, int startIndex, std::vector<std::string> sceneNamesToLoad); //TODO: make hash map for scenes
